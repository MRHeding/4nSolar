...
<div class="mb-6">
    ...
    <p class="text-gray-600 dark:text-gray-400">Welcome to <?php echo htmlspecialchars(getSystemSetting('company_title', '4NSOLAR ELECTRICZ')); ?> <?php echo htmlspecialchars(getSystemSetting('company_subtitle', 'Business Management System')); ?></p>
</div>
